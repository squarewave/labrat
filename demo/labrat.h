...
TEST_CASE(this_should_pass_true) {
    ASSERT_TRUE(true);
}

TEST_CASE(this_should_pass_eq) {
    int32_t actual = 42;
    int32_t expected = 42;
...
TEST_CASE(this_should_pass_not_eq) {
    int32_t actual = 41;
    int32_t expected = 42;
...
TEST_CASE(this_should_fail_true) {
    ASSERT_TRUE(false);
}

TEST_CASE(this_should_fail_eq) {
    int32_t actual = 41;
    int32_t expected = 42;
...
TEST_CASE(this_should_fail_not_eq) {
    int32_t actual = 42;
    int32_t expected = 42;
